...
> [!NOTE]  
> Configuration Manager current branch version 1910 is the baseline for these changes. For more information, see [Configuration Manager Cmdlet Library changes for version 1910](1910-release-notes.md).
