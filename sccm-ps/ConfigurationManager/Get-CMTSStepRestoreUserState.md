...
### ByValue (Default)
```
Get-CMTSStepRestoreUserState [-InputObject] <IResultObject> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ById
```
Get-CMTSStepRestoreUserState [-TaskSequenceId] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ByName
```
Get-CMTSStepRestoreUserState [-TaskSequenceName] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
- Remove the step from a task sequence with [Remove-CMTSStepRestoreUserState](Remove-CMTSStepRestoreUserState.md)
...
This example first gets a task sequence object in the **$tsOsd** variable. It then passes that variable as the input object to get the **Restore User State** step.
