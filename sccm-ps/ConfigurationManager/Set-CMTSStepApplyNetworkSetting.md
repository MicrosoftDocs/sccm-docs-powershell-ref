...
### ByValue (Default)
```
Set-CMTSStepApplyNetworkSetting [-AddAdapterSetting <IResultObject[]>] [-CleanAdapterSetting]
 [-DnsSuffix <String>] [-DomainName <String>] [-DomainOU <String>] [-EnableTcpIpFiltering <Boolean>]
 [-RemoveAdapterSettingName <String[]>] [-UserName <String>] [-UserPassword <SecureString>]
 [-WorkgroupName <String>] [-AddCondition <IResultObject[]>] [-ClearCondition] [-Description <String>]
...
```
Set-CMTSStepApplyNetworkSetting [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepApplyNetworkSetting [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepApplyNetworkSetting [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepApplyNetworkSetting [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepApplyNetworkSetting [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepApplyNetworkSetting -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepApplyNetworkSetting -InputObject <IResultObject> [-SetConditionOperatingSystem]
...
```
Set-CMTSStepApplyNetworkSetting -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepApplyNetworkSetting -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepApplyNetworkSetting [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepApplyNetworkSetting [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepApplyNetworkSetting [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepApplyNetworkSetting [-SetConditionOperatingSystem] [-StepName <String>]
