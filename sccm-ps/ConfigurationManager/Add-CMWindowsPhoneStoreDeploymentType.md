...
### ByAppName (Default)
```
Add-CMWindowsPhoneStoreDeploymentType -Url <String> [-DeploymentTypeName <String>] [-AddRequirement <Rule[]>]
...
**Add-CMWindowsPhoneStoreDeploymentType** adds a Windows Phone app package (in the Windows Store) deployment type named DT2 from the provided URL in English and Chinese.
...
[Set-CMWindowsPhoneStoreDeploymentType](Set-CMWindowsPhoneStoreDeploymentType.md)
