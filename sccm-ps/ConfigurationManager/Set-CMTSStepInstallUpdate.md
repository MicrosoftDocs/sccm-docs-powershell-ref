...
This example changes the **Install Software Updates** step in the **Default OS deployment** task sequence to only install required updates and not use the scan cache.
