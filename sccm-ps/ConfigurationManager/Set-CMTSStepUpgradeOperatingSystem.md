...
```
Set-CMTSStepUpgradeOperatingSystem [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepUpgradeOperatingSystem [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepUpgradeOperatingSystem [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepUpgradeOperatingSystem [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepUpgradeOperatingSystem [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepUpgradeOperatingSystem -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepUpgradeOperatingSystem -InputObject <IResultObject> [-SetConditionOperatingSystem]
...
```
Set-CMTSStepUpgradeOperatingSystem -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepUpgradeOperatingSystem -InputObject <IResultObject> [-IsAnyVersion <Boolean>]
...
```
Set-CMTSStepUpgradeOperatingSystem [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepUpgradeOperatingSystem [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepUpgradeOperatingSystem [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepUpgradeOperatingSystem [-SetConditionOperatingSystem] [-StepName <String>]
