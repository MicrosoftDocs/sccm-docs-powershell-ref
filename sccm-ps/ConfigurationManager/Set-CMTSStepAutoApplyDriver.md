...
### ByValue (Default)
```
Set-CMTSStepAutoApplyDriver [-ConsiderAllCategories] [-DriverCategory <IResultObject[]>]
 [-InstallDriverOption <InstallDriverType>] [-IsAllowedUnsignedDriver <Boolean>]
...
```
Set-CMTSStepAutoApplyDriver [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepAutoApplyDriver [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepAutoApplyDriver [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepAutoApplyDriver [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepAutoApplyDriver [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepAutoApplyDriver -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepAutoApplyDriver -InputObject <IResultObject> [-SetConditionOperatingSystem] [-StepName <String>]
...
```
Set-CMTSStepAutoApplyDriver -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepAutoApplyDriver -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepAutoApplyDriver [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepAutoApplyDriver [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepAutoApplyDriver [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepAutoApplyDriver [-SetConditionOperatingSystem] [-StepName <String>]
...
This example changes the **Auto Apply Drivers** step in the **Default OS deployment** task sequence to consider drives from all categories.
