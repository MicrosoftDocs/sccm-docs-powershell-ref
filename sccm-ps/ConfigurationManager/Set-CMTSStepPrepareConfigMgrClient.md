...
### ByValue (Default)
```
Set-CMTSStepPrepareConfigMgrClient [-AddCondition <IResultObject[]>] [-ClearCondition] [-Description <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepPrepareConfigMgrClient [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepPrepareConfigMgrClient [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient -InputObject <IResultObject> [-SetConditionOperatingSystem]
...
```
Set-CMTSStepPrepareConfigMgrClient -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepPrepareConfigMgrClient -InputObject <IResultObject> [-IsAnyVersion <Boolean>]
...
```
Set-CMTSStepPrepareConfigMgrClient [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepPrepareConfigMgrClient [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepPrepareConfigMgrClient [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepPrepareConfigMgrClient [-SetConditionOperatingSystem] [-StepName <String>]
