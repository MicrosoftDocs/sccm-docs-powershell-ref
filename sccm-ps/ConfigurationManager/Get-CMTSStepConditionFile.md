...
```
Get-CMTSStepConditionFile -InputObject <IResultObject> [-DisableWildcardHandling] [-ForceWildcardHandling]
 [<CommonParameters>]
```

## DESCRIPTION

Use this cmdlet to get a _file properties_ condition object from a task sequence step. You can use this object to:
