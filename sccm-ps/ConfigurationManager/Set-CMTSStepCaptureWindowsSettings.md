...
Set-CMTSStepCaptureWindowsSettings [-MigrateComputerName <Boolean>] [-MigrateRegistrationInfo <Boolean>]
 [-MigrateTimeZone <Boolean>] [-AddCondition <IResultObject[]>] [-ClearCondition] [-Description <String>]
...
```
Set-CMTSStepCaptureWindowsSettings [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepCaptureWindowsSettings [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepCaptureWindowsSettings [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepCaptureWindowsSettings [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepCaptureWindowsSettings [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepCaptureWindowsSettings -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepCaptureWindowsSettings -InputObject <IResultObject> [-SetConditionOperatingSystem]
...
```
Set-CMTSStepCaptureWindowsSettings -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepCaptureWindowsSettings -InputObject <IResultObject> [-IsAnyVersion <Boolean>]
...
```
Set-CMTSStepCaptureWindowsSettings [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepCaptureWindowsSettings [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepCaptureWindowsSettings [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepCaptureWindowsSettings [-SetConditionOperatingSystem] [-StepName <String>]
