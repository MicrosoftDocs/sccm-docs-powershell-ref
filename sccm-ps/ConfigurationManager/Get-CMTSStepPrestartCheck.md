...
### ByValue (Default)
```
Get-CMTSStepPrestartCheck [-InputObject] <IResultObject> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ById
```
Get-CMTSStepPrestartCheck [-TaskSequenceId] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ByName
```
Get-CMTSStepPrestartCheck [-TaskSequenceName] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
- Remove the step from a task sequence with [Remove-CMTSStepPrestartCheck](Remove-CMTSStepPrestartCheck.md)
...
This example first gets a task sequence object in the **$tsOsd** variable. It then passes that variable as the input object to get the **Check Readiness** step.
