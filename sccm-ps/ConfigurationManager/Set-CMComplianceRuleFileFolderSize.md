---
description: Sets a compliance rule file folder size.
external help file: AdminUI.PS.dll-Help.xml
Module Name: ConfigurationManager
ms.date: 05/07/2019
schema: 2.0.0
title: Set-CMComplianceRuleFileFolderSize
---
...
### ByCI
```
Set-CMComplianceRuleFileFolderSize [-ExpectedValue <Int64[]>] [-ExpressionOperator <RuleExpressionOperator>]
