...
### ByValue (Default)
```
Remove-CMPersistentUserSettingsGroup [-Force] [-Name <String>] [-DisableWildcardHandling]
 [-ForceWildcardHandling] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SearchByValueMandatory
```
Remove-CMPersistentUserSettingsGroup [-Force] [-Name <String>] -InputObject <IResultObject>
