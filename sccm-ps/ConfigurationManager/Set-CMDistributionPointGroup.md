...
### Example 1: Rename Distribution Point Group and add a Description
```
PS C:\> Set-CMDistributionPointGroup -Name "My DP Group" -NewName "All DPs" -Description "Contains all DPs"
```
