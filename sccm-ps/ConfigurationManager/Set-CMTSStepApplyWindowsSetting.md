...
```
Set-CMTSStepApplyWindowsSetting [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepApplyWindowsSetting [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepApplyWindowsSetting [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepApplyWindowsSetting [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepApplyWindowsSetting [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepApplyWindowsSetting -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepApplyWindowsSetting -InputObject <IResultObject> [-SetConditionOperatingSystem]
...
```
Set-CMTSStepApplyWindowsSetting -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepApplyWindowsSetting -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepApplyWindowsSetting [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepApplyWindowsSetting [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepApplyWindowsSetting [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepApplyWindowsSetting [-SetConditionOperatingSystem] [-StepName <String>]
