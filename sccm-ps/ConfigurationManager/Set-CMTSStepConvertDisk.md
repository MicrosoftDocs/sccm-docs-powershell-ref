...
### ByValue (Default)
```
Set-CMTSStepConvertDisk [-DiskNumber <Int32>] [-AddCondition <IResultObject[]>] [-ClearCondition]
...
```
Set-CMTSStepConvertDisk [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepConvertDisk [-Condition <IResultObject[]>] -InputObject <IResultObject> [-SetConditionIfStatement]
...
```
Set-CMTSStepConvertDisk [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepConvertDisk [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepConvertDisk [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepConvertDisk -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepConvertDisk -InputObject <IResultObject> [-SetConditionOperatingSystem] [-StepName <String>]
...
```
Set-CMTSStepConvertDisk -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepConvertDisk -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepConvertDisk [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepConvertDisk [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi] [-StepName <String>]
 -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
```
Set-CMTSStepConvertDisk [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepConvertDisk [-SetConditionOperatingSystem] [-StepName <String>]
