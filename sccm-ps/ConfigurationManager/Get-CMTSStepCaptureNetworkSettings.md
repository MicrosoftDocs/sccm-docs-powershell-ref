...
### ByValue (Default)
```
Get-CMTSStepCaptureNetworkSettings [-InputObject] <IResultObject> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ById
```
Get-CMTSStepCaptureNetworkSettings [-TaskSequenceId] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

### ByName
```
Get-CMTSStepCaptureNetworkSettings [-TaskSequenceName] <String> [-StepName <String>] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
- Remove the step from a task sequence with [Remove-CMTSStepCaptureNetworkSettings](Remove-CMTSStepCaptureNetworkSettings.md)
...
This example first gets a task sequence object in the **$tsOsd** variable. It then passes that variable as the input object to get the **Capture Network Settings** step.
