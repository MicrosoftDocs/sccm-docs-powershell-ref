...
This feature was introduced in [Configuration Manager 1806](https://docs.microsoft.com/en-us/sccm/core/plan-design/changes/whats-new-in-version-1806#improvements-to-pxe-enabled-distribution-points).
ConfigMgr PXE Responder Service is the service that will replace the functionality of Windows Deployment Services.
