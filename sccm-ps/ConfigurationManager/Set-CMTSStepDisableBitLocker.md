...
### ByValue (Default)
```
Set-CMTSStepDisableBitLocker [-CurrentDrive] [-Drive <String>] [-RebootCount <Int32>]
...
```
Set-CMTSStepDisableBitLocker [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepDisableBitLocker [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepDisableBitLocker [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepDisableBitLocker [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepDisableBitLocker [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepDisableBitLocker -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepDisableBitLocker -InputObject <IResultObject> [-SetConditionOperatingSystem] [-StepName <String>]
...
```
Set-CMTSStepDisableBitLocker -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepDisableBitLocker -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepDisableBitLocker [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepDisableBitLocker [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepDisableBitLocker [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepDisableBitLocker [-SetConditionOperatingSystem] [-StepName <String>]
