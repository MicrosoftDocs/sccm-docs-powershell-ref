...
ms.date: 05/07/2019
schema: 2.0.0
title: Set-CMClientSettingComplianceSetting
---
...
```
Set-CMClientSettingComplianceSetting [-Enable <Boolean>] [-EnableUserDataAndProfile <Boolean>] -Name <String>
...
Type: Boolean
Parameter Sets: (All)
Aliases: EnableComplianceEvaluation
