...
```
New-CMTSStepConnectNetworkFolder -Path <String> [-Drive <String>] -UserName <String>
 [-UserPassword <SecureString>] -Name <String> [-Description <String>] [-ContinueOnError] [-Disable]
