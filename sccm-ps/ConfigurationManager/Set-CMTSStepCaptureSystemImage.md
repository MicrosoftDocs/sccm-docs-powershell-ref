...
### ByValue (Default)
```
Set-CMTSStepCaptureSystemImage [-ImageCreator <String>] [-ImageDescription <String>] [-ImageVersion <String>]
 [-Password <SecureString>] [-Path <String>] [-UserName <String>] [-AddCondition <IResultObject[]>]
...
```
Set-CMTSStepCaptureSystemImage [-Condition <IResultObject[]>] [-SetConditionIfStatement]
...
```
Set-CMTSStepCaptureSystemImage [-Condition <IResultObject[]>] -InputObject <IResultObject>
...
```
Set-CMTSStepCaptureSystemImage [-ConditionVariableName <String>] [-ConditionVariableValue <String>]
...
```
Set-CMTSStepCaptureSystemImage [-FileDateTimeOperator <VariableOperatorType>] [-FilePath <String>]
...
```
Set-CMTSStepCaptureSystemImage [-FolderDateTimeOperator <VariableOperatorType>] [-FolderPath <String>]
...
```
Set-CMTSStepCaptureSystemImage -InputObject <IResultObject> [-Namespace <String[]>] [-Query <String>]
...
```
Set-CMTSStepCaptureSystemImage -InputObject <IResultObject> [-SetConditionOperatingSystem] [-StepName <String>]
...
```
Set-CMTSStepCaptureSystemImage -InputObject <IResultObject> [-RegistryKey <String>]
...
```
Set-CMTSStepCaptureSystemImage -InputObject <IResultObject> [-IsAnyVersion <Boolean>] [-MsiFilePath <String>]
...
```
Set-CMTSStepCaptureSystemImage [-IsAnyVersion <Boolean>] [-MsiFilePath <String>] [-SetConditionSoftware]
...
```
Set-CMTSStepCaptureSystemImage [-Namespace <String[]>] [-Query <String>] [-SetConditionQueryWmi]
 [-StepName <String>] -TaskSequenceId <String> [-DisableWildcardHandling] [-ForceWildcardHandling] [-WhatIf]
 [-Confirm] [<CommonParameters>]
```
...
```
Set-CMTSStepCaptureSystemImage [-RegistryKey <String>] [-RegistryOperator <VariableOperatorType>]
...
```
Set-CMTSStepCaptureSystemImage [-SetConditionOperatingSystem] [-StepName <String>]
