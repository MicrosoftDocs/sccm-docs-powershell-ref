...
```
Get-CMTSStepConditionRegistry -InputObject <IResultObject> [-DisableWildcardHandling] [-ForceWildcardHandling]
 [<CommonParameters>]
```

## DESCRIPTION

Use this cmdlet to get a _registry setting_ condition object from a task sequence step. You can use this object to:
