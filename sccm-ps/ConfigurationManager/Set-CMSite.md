...
To obtain an Active Directory Forest object, use the [Get-ADForest](https://docs.microsoft.com/powershell/module/addsadministration/get-adforest?view=win10-ps) cmdlet.
